    ...
    <BlockMain>
      ...
      <div className="rightDiv">
        <div>
          <h1>VOCÊ RECEBERÁ:</h1>
          <p>
            Amanhã: <span>R$ {value === "" ? "0,00" : value[1]}</span>
          </p>
          <p>
            Em 15 dias: <span>R$ {value === "" ? "0,00" : value[15]}</span>
          </p>
          <p>
            Em 30 dias: <span>R$ {value === "" ? "0,00" : value[30]}</span>
          </p>
          <p>
            Em 90 dias: <span>R$ {value === "" ? "0,00" : value[90]}</span>
          </p>
        </div>
      </div>
    </BlockMain>
